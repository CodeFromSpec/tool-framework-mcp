...
func main() {
	...
	type LoadChainArgs struct {
		Token string `json:"token" jsonschema:"Opaque token identifying the target node, as returned by create_token."`
	}
	mcp.AddTool(s, &mcp.Tool{
		...
		result, err := mcploadchain.MCPLoadChain(args.Token)
		if err != nil {
