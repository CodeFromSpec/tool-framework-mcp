...
input: ARTIFACT/golang/implementation/internal/chain_resolver/code(chainresolver)
outputs:
  - id: chainresolver_test
    path: internal/chainresolver/chainresolver_test.go
---

# ROOT/golang/tests/internal/chain_resolver

Test cases for the chainresolver package.
