---
input: ARTIFACT/golang/implementation/internal/pathvalidation/code(pathvalidation)
outputs:
  - id: pathvalidation_test
    path: internal/pathvalidation/pathvalidation_test.go
---

# ROOT/golang/tests/internal/pathvalidation

Unit tests for the pathvalidation package.
...
Input: `"cmd/framework-mcp/main.go"`, project root = temp dir.
Expect: no error.
