---
depends_on:
  - ROOT/functional/logic/utils/artifact_tag(interface)
outputs:
  - id: artifact_tag_tests
    path: code-from-spec/functional/tests/utils/artifact_tag/output.md
---

# ROOT/functional/tests/utils/artifact_tag
